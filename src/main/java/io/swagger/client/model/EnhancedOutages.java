 ...
 */
@Schema(description = "An array of outages enhanced with extra information")
...
public class EnhancedOutages extends ArrayList<EnhancedOutagesInner> {
  ...
  public String toString() {
    ...
    sb.append("class EnhancedOutages {\n");
